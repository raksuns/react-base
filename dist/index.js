...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // src/presentation/view/auth/AuthComponent.tsx
  var import_react = __toModule(require_react());
  var AuthComponent = class extends import_react.default.Component {
    constructor(props) {
      super(props);
    ...
    render() {
      ...
      return /* @__PURE__ */ import_react.default.createElement("div", {
        ...
        className: "auth-container col bg-white border rounded-lg py-4 px-5"
      }, /* @__PURE__ */ import_react.default.createElement("div", {
        className: "row mt-2 mb-4"
      }, "Status:\xA0", /* @__PURE__ */ import_react.default.createElement("span", {
        className: `${isAuthStatusPositive ? "text-success" : "text-danger"}`
      }, authStatus)), /* @__PURE__ */ import_react.default.createElement("div", {
        className: "row mt-2"
        ...
        value: passwordQuery,
        className: "form-control"
      })), isShowError && /* @__PURE__ */ import_react.default.createElement("div", {
        className: "row my-3 text-danger justify-content-center"
      }, errorMessage), isSignInButtonVisible && /* @__PURE__ */ import_react.default.createElement("div", {
        className: "row mt-4"
      }, /* @__PURE__ */ import_react.default.createElement("button", {
        type: "button",
        className: "col btn btn-primary",
        onClick: () => this.authViewModel.onClickSignIn()
      }, "Sign in")), isSignOutButtonVisible && /* @__PURE__ */ import_react.default.createElement("div", {
        className: "row mt-4"
      }, /* @__PURE__ */ import_react.default.createElement("button", {
        type: "button",
        className: "col btn btn-primary",
        onClick: () => this.authViewModel.onClickSignOut()
      }, "Sign out"))));
    }
  };

  // src/presentation/util/FormValidator.tsx
  ...
  // src/presentation/view-model/auth/AuthViewModelImpl.tsx
  var AuthViewModelImpl = class {
    constructor(loginUseCase, authHolder) {
      this.attachView = (baseView) => {
        this.baseView = baseView;
      };
      this.detachView = () => {
        this.baseView = void 0;
      };
      this.onAuthChanged = () => {
      ...
      this.onEmailQueryChanged = (loginQuery) => {
        this.emailQuery = loginQuery;
        this.notifyViewAboutChanges();
      };
      this.onPasswordQueryChanged = (passwordQuery) => {
        this.passwordQuery = passwordQuery;
        this.notifyViewAboutChanges();
      };
      this.onClickSignIn = () => __async(this, null, function* () {
        if (!this.validateLoginForm()) {
          this.notifyViewAboutChanges();
          return;
        }
        try {
          yield this.loginUseCase.loginUser(this.emailQuery, this.passwordQuery);
  ...
  // src/data/auth/AuthFakeApi.tsx
  var AuthFakeApi = class {
    ...
    login(email, password, validationKey) {
      return new Promise((resolve, reject) => {
  ...
  // src/domain/interactors/auth/LoginUseCase.tsx
  var LoginUseCase = class {
    constructor(authRepository, authHolder) {
      this.authRepository = authRepository;
      this.authHolder = authHolder;
    }
    loginUser(email, password) {
      return __async(this, null, function* () {
        const validationResult = yield this.authRepository.validateCredentials(email, password);
        const authResult = yield this.authRepository.login(email, password, validationResult.validationKey);
        this.authHolder.onSignedIn(authResult.authorizationToken);
      });
    }
  };

  // src/domain/entity/auth/models/AuthHolder.tsx
  var AuthHolder = class {
    constructor() {
  ...
  function App() {
    ...
    }, /* @__PURE__ */ import_react2.default.createElement(AuthComponent, {
      authViewModel
    }));
  }
  var App_default = App;
